    ...
    return (
      ...
      >
        <div style={{ textAlign: 'center', padding: '40px', maxWidth: '600px' }}>
          ...
          <h1 style={{ color: '#fbbf24', fontSize: '1.5rem', marginBottom: '12px' }}>OpenHamClock hit an error</h1>
          <p style={{ color: '#aaa', marginBottom: '24px', lineHeight: 1.6 }}>
            Something went wrong rendering the dashboard. This usually fixes itself after a reload. If it keeps
            happening, try clearing your browser cache.
          </p>
